...
%%% Computing Skills
%%% ------------------------------------------------------------
\NewPart{Software \& Computing}{}
\vspace{-7pt}

\begin{itemize}[noitemsep]

\item \EducationEntry{Author/maintainer \href{https://cran.r-project.org/web/packages/bigsimr/index.html}{https://cran.r-project.org/web/packages/bigsimr/index.html}}{}{\textsc{bigsimr} R Package}{}

\vspace{2pt}
  
\item \EducationEntry{Author \href{http://www.lussiergroup.org/publications/N-of-1-pathways}{http://www.lussiergroup.org}}{}{\textsc{nof1} R Package }{}

\vspace{4pt}
  
\item \EducationEntry{Programming/Scripting Languages}{}{\textsc{R, bash, PBS/LSF High-performance computing, Python, SQL}}{}

\vspace{4pt}
  
\item \EducationEntry{Statistical Packages}{}{\textsc{SPSS, SAS 9} (Certified Advanced Programmer)\textsc{, Minitab, R}}{}

\vspace{4pt}
  
\item \EducationEntry{Operating Systems}{}{\textsc{Mac OS, Windows, Linux}}{}

\vspace{4pt}
  
\item \EducationEntry{Reproducible Research/Publishing}{}{{\LaTeX, \textsc{R Markdown, Emacs Org-mode, MS Word, Adobe Illustrator, git}}}
