...
\begin{enumerate}
 ...
 \item \PaperEntry{\underline{A.~Grant Schissler}, Hung Nguyen, Tin Nguyen, Juli Petereit, Vincent Gardeux}{Statistical Software$^{*}$}{invited article}{Wiley StatsRef-Statistics Reference Online
}{}{2018}{}
%% \item none
...
\item \PaperEntry{Jingyu Liu, Walter W.~Piegorsch, \underline{A.~Grant Schissler}, Rachel E.~Reeves, and Susan L.~Cutter}{Extending spatial adjustments for benchmark risk to non-spatial autocorrelation, with application to natural hazard risk assessments}{}{Journal of the Royal Statistical Society:~Series A}{}{Sep 2018$^{*}$}{}

    \item \PaperEntry{Xiang Li, \underline{A.~Grant Schissler}, and Frederick C.~Harris, Jr.}{Accelerating multivariate simulation using Graphical Processing Units with applications to RNA-seq data}{}{}{}{Oct 2018$^{*}$}{}
