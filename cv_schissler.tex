...
\item \PaperEntry{Jingyu Liu, Walter W.~Piegorsch, \underline{A.~Grant Schissler}, Rachel R.~McCaster, and Susan L.~Cutter}{Extending spatial adjustments for benchmark risk analysis to non-spatial autocorrelation, with application to natural hazard risk assessment}{}{Journal of Applied Statistics}{}{submitted Feb 2020}{}

  \item \PaperEntry{Austin Witt$^{\dagger}$, Taylor Gurnea$^{\dagger}$, Franklin Fuchs$^{\dagger}$, Sahar Sedigh$^{\dagger}$, and \underline{A.~Grant Schissler}}{Assessing an active learning-based curriculum in high-stakes medical student achievement examinations with limited data via Bayesian statistics}{}{American Medical Student Research Journal}{}{submitted Jul 2020}{}

  \item \PaperEntry{Alexander D. Knudson$^{\dagger}$, Tomasz J. Kozubowski, Anna K. Panorska and \underline{Alfred G.~Schissler}}{A flexible multivariate model for high-dimensional correlated count data analysis and simulation}{}{Journal of Statistical Distributions and Applications}{}{submitted Oct 2020}{}
...
% \item \ThesisEntry{Matthew Ohemeng}{PhD in Statistics \& Data Science}{}{TBD}{ongoing}
...
\item \ThesisEntry{Janyne Little}{MS in Natural Resources \& Environmental Science}{}{Post-Wildfire Livestock Grazing Management on Public Rangelands in Northeast California}{Summer 2019}
  ...
  \item \ThesisEntry{Samantha Faulstich}{MS in Atmospheric Science}{}{Evaluating Fire Emissions Inventories in the Western U.S. With the Development of a Bayesian Model}{expected Spring 2021}
...
\vspace{-7pt}
\EducationEntry{Software creator/maintainer \href{http://www.lussiergroup.org/publications/N-of-1-pathways}{http://www.lussiergroup.org}}{}{\textsc{nof1} R Package, \textsc{bigsimr} R Package }{}
