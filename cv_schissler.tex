...
\EducationEntry{Reproducible Research/Publishing}{}{{\LaTeX, \textsc{Emacs Org-mode, MS Word, Adobe Illustrator, git}}}
...
\begin{itemize}
\item \emph{\small{``Doctor Schissler cares very much about student success. He is empathetic, understanding, and passionate about the subject material! The flipped classroom approach takes some getting used to, but it does make the ``ah-ha'' moments when something clicks all the
more satisfying.''}}
